...
public class EventBusServiceBus : IEventBus, IDisposable
{
    ...
    private readonly string _topicName = Environment.GetEnvironmentVariable("BUS_TOPIC") ?? string.Empty;
    private readonly string _subscriptionName;
    private ServiceBusSender _sender;
    private ServiceBusProcessor _processor;
    private readonly string AUTOFAC_SCOPE_NAME = Environment.GetEnvironmentVariable("BUS_TOPIC") ?? string.Empty;
